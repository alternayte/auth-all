...
var scenarios = []scenario{
	...
	// The scenarios of the v1.1 release. Section 9 of
	// docs/auth-all-next-sdd.md names them.
...
func main() {
	...
	out := flag.String("out", "artifacts/v1.1-verification.md", "the evidence file")
	flag.Parse()
...
func render(results map[string]string, skipped []string, checks []checkResult) (string, int) {
	...
	b.WriteString("# Auth-All v1.1 verification evidence\n\n")
