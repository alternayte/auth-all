...
func TestSCNSCH003TheCLIExportsTheMigrationFiles(t *testing.T) {
	cases := []struct {
		...
		{"goose", []string{
			...
			"20261101000001_authall_organizations.sql",
			"20261101000002_authall_org_members.sql",
			"20261101000003_authall_org_invitations.sql",
			"20261101000004_authall_org_roles.sql",
		...
		{"plain", []string{
			...
			"20261101000001_authall_organizations.up.sql",
			"20261101000001_authall_organizations.down.sql",
			"20261101000002_authall_org_members.up.sql",
			"20261101000002_authall_org_members.down.sql",
			"20261101000003_authall_org_invitations.up.sql",
			"20261101000003_authall_org_invitations.down.sql",
			"20261101000004_authall_org_roles.up.sql",
			"20261101000004_authall_org_roles.down.sql",
			"20261101000005_authall_org_teams.up.sql",
			"20261101000005_authall_org_teams.down.sql",
			"20261101000006_authall_org_columns.up.sql",
